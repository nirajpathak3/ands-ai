"""The AI Gateway: the single LLM egress (Day 11, ADR-006 / ADR-014).

One place owns routing, semantic caching, ordered fallback, and cost/latency/token
tracking — so cost control and observability live in exactly one seam and the rest of the
runtime stays provider-agnostic. ``complete()`` is the only entry point:
...
never raises: it returns the reproducible analysis with $0 cost.
"""
